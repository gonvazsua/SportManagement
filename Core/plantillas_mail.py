...
def plantilla_email_pass(nombre_int, password_int):
    ...
    texto += '									<tr>'
    texto += '										<td align="center" valign="top"><img src="http://www.sportclick.club/static/css/../img/img_mail/bluebox_top.png" width="210" height="14" style="display:block;"></td>'
    texto += '									</tr>'
    texto += '									<tr>'
    texto += '										<td align="center" valign="top" bgcolor="#1ba5db" style="background-color:#1ba5db;">'
    ...
    texto += '														<div><img src="http://www.sportclick.club/static/css/../img/img_mail/pinkbox_divider.png" style="display:block"></div>'
    ...
    texto += '									</tr>'
    texto += '									<tr>'
    texto += '									  <td align="center" valign="top"><img src="http://www.sportclick.club/static/css/../img/img_mail/bluebox_bot.png" width="210" height="14" style="display:block;"></td>'
    texto += '									</tr>'
    texto += '								</table>'
    texto += '							</td>'
    texto += '						</tr>'
